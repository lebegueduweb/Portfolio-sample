...
class Year(models.Model):
    name = models.DateField(null=True, blank=True, help_text="Enter the year of publication")
...
class Book(models.Model):
    ...
    year = models.DateField(null=True, blank=True, help_text="Enter the year of publication")
    ...
    def display_year(self,):
        return join([year.title for year in self.year.all()[:3]])
